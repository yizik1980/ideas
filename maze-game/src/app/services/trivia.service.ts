...
const QUESTIONS: TriviaQuestion[] = [
  ...
  // ===== גן – עברית – שאלות אותיות =====
  { id: 241, difficulty: 'gan', category: 'hebrew', points: 1, question: 'איזו תמונה מתחילה באות א?', answers: ['✈️', '🎈', '🦓', '🐒'],    correctIndex: 0 },
  { id: 242, difficulty: 'gan', category: 'hebrew', points: 1, question: 'איזו תמונה מתחילה באות ב?', answers: ['🌹', '🎈', '🚜', '📿'],    correctIndex: 1 },
  { id: 243, difficulty: 'gan', category: 'hebrew', points: 1, question: 'איזו תמונה מתחילה באות ג?', answers: ['🍯', '🥛', '⚙️', '🌙'],    correctIndex: 2 },
  { id: 244, difficulty: 'gan', category: 'hebrew', points: 1, question: 'איזו תמונה מתחילה באות ד?', answers: ['🐕', '🤡', '✈️', '🍯'],    correctIndex: 3 },
  { id: 245, difficulty: 'gan', category: 'hebrew', points: 1, question: 'איזו תמונה מתחילה באות ה?', answers: ['🦛', '🧣', '🔦', '🐜'],    correctIndex: 0 },
  { id: 246, difficulty: 'gan', category: 'hebrew', points: 1, question: 'איזו תמונה מתחילה באות ו?', answers: ['🐒', '🌹', '🎈', '🚜'],    correctIndex: 1 },
  { id: 247, difficulty: 'gan', category: 'hebrew', points: 1, question: 'איזו תמונה מתחילה באות ז?', answers: ['🍯', '🌙', '🦓', '📿'],    correctIndex: 2 },
  { id: 248, difficulty: 'gan', category: 'hebrew', points: 1, question: 'איזו תמונה מתחילה באות ח?', answers: ['🤡', '⚙️', '✈️', '🥛'],    correctIndex: 3 },
  { id: 249, difficulty: 'gan', category: 'hebrew', points: 1, question: 'איזו תמונה מתחילה באות ט?', answers: ['🚜', '🦛', '🐕', '🌹'],    correctIndex: 0 },
  { id: 250, difficulty: 'gan', category: 'hebrew', points: 1, question: 'איזו תמונה מתחילה באות י?', answers: ['🎈', '🌙', '🧣', '🐒'],    correctIndex: 1 },
  { id: 251, difficulty: 'gan', category: 'hebrew', points: 1, question: 'איזו תמונה מתחילה באות כ?', answers: ['🦓', '🐜', '🐕', '🔦'],    correctIndex: 2 },
  { id: 252, difficulty: 'gan', category: 'hebrew', points: 1, question: 'איזו תמונה מתחילה באות ל?', answers: ['⚙️', '🍯', '🥛', '🤡'],    correctIndex: 3 },
  { id: 253, difficulty: 'gan', category: 'hebrew', points: 1, question: 'איזו תמונה מתחילה באות מ?', answers: ['🛫', '🛋️', '🌹', '🎈'],    correctIndex: 0 },
  { id: 254, difficulty: 'gan', category: 'hebrew', points: 1, question: 'איזו תמונה מתחילה באות נ?', answers: ['🚜', '🐜', '🌙', '🤡'],    correctIndex: 1 },
  { id: 255, difficulty: 'gan', category: 'hebrew', points: 1, question: 'איזו תמונה מתחילה באות ס?', answers: ['🦓', '🦛', '🛋️', '📿'],    correctIndex: 2 },
  { id: 256, difficulty: 'gan', category: 'hebrew', points: 1, question: 'איזו תמונה מתחילה באות ע?', answers: ['🐒', '🧣', '🥛', '🪁'],    correctIndex: 3 },
  { id: 257, difficulty: 'gan', category: 'hebrew', points: 1, question: 'איזו תמונה מתחילה באות פ?', answers: ['🔦', '⚙️', '🐕', '🎈'],    correctIndex: 0 },
  { id: 258, difficulty: 'gan', category: 'hebrew', points: 1, question: 'איזו תמונה מתחילה באות צ?', answers: ['🍯', '🧣', '🦛', '✈️'],    correctIndex: 1 },
  { id: 259, difficulty: 'gan', category: 'hebrew', points: 1, question: 'איזו תמונה מתחילה באות ק?', answers: ['🌙', '🌹', '🐒', '🐜'],    correctIndex: 2 },
  { id: 260, difficulty: 'gan', category: 'hebrew', points: 1, question: 'איזו תמונה מתחילה באות ר?', answers: ['🚜', '🤡', '📿', '🪇'],    correctIndex: 3 },
  { id: 261, difficulty: 'gan', category: 'hebrew', points: 1, question: 'איזו תמונה מתחילה באות ש?', answers: ['📿', '🦓', '🥛', '🛋️'],    correctIndex: 0 },
  { id: 262, difficulty: 'gan', category: 'hebrew', points: 1, question: 'איזו תמונה מתחילה באות ת?', answers: ['🔦', '🐓', '🪁', '🐕'],    correctIndex: 1 },

  // ===== עברית – א-ב (קריאה בסיסית) =====
  { id: 263, difficulty: '1-2', category: 'hebrew', points: 1, question: 'מה ההפך של "חם"?',                         answers: ['יפה', 'קר', 'מהיר', 'גדול'],                  correctIndex: 1 },
  { id: 264, difficulty: '1-2', category: 'hebrew', points: 1, question: 'איזו מילה היא שם עצם?',                    answers: ['יפה', 'רץ', 'כלב', 'אדום'],                   correctIndex: 2 },
  { id: 265, difficulty: '1-2', category: 'hebrew', points: 1, question: 'השלם: "הילד ___ לבית הספר"',               answers: ['הלכה', 'הלך', 'הלכו', 'ללכת'],                correctIndex: 1 },
  { id: 266, difficulty: '1-2', category: 'hebrew', points: 1, question: 'מה ריבוי של "כלב"?',                       answers: ['כלבה', 'כלבים', 'כלבות', 'כלבן'],             correctIndex: 1 },
  { id: 267, difficulty: '1-2', category: 'hebrew', points: 1, question: 'איזו מילה היא פועל?',                       answers: ['שמש', 'ספר', 'רץ', 'ילד'],                    correctIndex: 2 },
  { id: 268, difficulty: '1-2', category: 'hebrew', points: 1, question: 'מה נקבת "ילד"?',                           answers: ['ילדות', 'ילדה', 'ילדים', 'ילדן'],             correctIndex: 1 },
  { id: 269, difficulty: '1-2', category: 'hebrew', points: 1, question: 'השלם: "הילדה ___ בגן"',                    answers: ['שיחקה', 'שיחק', 'שיחקו', 'שיחקת'],           correctIndex: 0 },
  { id: 270, difficulty: '1-2', category: 'hebrew', points: 1, question: 'מה ריבוי של "ספר"?',                       answers: ['ספרות', 'ספרים', 'ספרן', 'ספרה'],             correctIndex: 1 },
  { id: 271, difficulty: '1-2', category: 'hebrew', points: 1, question: 'מה ההפך של "קצר"?',                        answers: ['רחב', 'גבוה', 'ארוך', 'עגול'],                correctIndex: 2 },
  { id: 272, difficulty: '1-2', category: 'hebrew', points: 1, question: 'איזו מילה היא תואר?',                       answers: ['חתול', 'רץ', 'יפה', 'בית'],                   correctIndex: 2 },
  { id: 273, difficulty: '1-2', category: 'hebrew', points: 1, question: 'מה נקבת "מורה" (זכר)?',                    answers: ['מורות', 'מורה (נקבה)', 'מורית', 'מוריה'],     correctIndex: 1 },
  { id: 274, difficulty: '1-2', category: 'hebrew', points: 1, question: 'השלם: "אני ___ לבית" (הווה)',              answers: ['הלכתי', 'הולך/ת', 'ילך', 'לכת'],              correctIndex: 1 },
  { id: 275, difficulty: '1-2', category: 'hebrew', points: 1, question: 'מה ריבוי של "עץ"?',                        answers: ['עצות', 'עצים', 'עצן', 'עצות'],               correctIndex: 1 },
  { id: 276, difficulty: '1-2', category: 'hebrew', points: 1, question: 'מה ההפך של "מהר"?',                        answers: ['יפה', 'לאט', 'קצר', 'קל'],                    correctIndex: 1 },
  { id: 277, difficulty: '1-2', category: 'hebrew', points: 1, question: 'איזו מילה היא שם פרטי?',                   answers: ['ילד', 'בית', 'דוד', 'כלב'],                   correctIndex: 2 },
  { id: 278, difficulty: '1-2', category: 'hebrew', points: 1, question: 'מה ריבוי של "שולחן"?',                     answers: ['שולחנות', 'שולחנים', 'שולחנן', 'שולחני'],    correctIndex: 0 },
  { id: 279, difficulty: '1-2', category: 'hebrew', points: 1, question: 'השלם: "הם ___ בגינה" (עבר)',               answers: ['שיחק', 'שיחקה', 'שיחקו', 'שיחקת'],           correctIndex: 2 },
  { id: 280, difficulty: '1-2', category: 'hebrew', points: 1, question: 'מה נקבה רבים של "ילד"?',                   answers: ['ילדות', 'ילדים', 'ילדה', 'ילדן'],             correctIndex: 0 },
  { id: 281, difficulty: '1-2', category: 'hebrew', points: 1, question: 'מה ההפך של "כבד"?',                        answers: ['גדול', 'קל', 'גבוה', 'רחב'],                  correctIndex: 1 },
  { id: 282, difficulty: '1-2', category: 'hebrew', points: 1, question: 'איזו מילה כתובה נכון?',                    answers: ['אכל', 'אחל', 'אגל', 'אכלה → "אכלה"'],         correctIndex: 0 },

  // ===== עברית – ג-ד (קריאה ודקדוק) =====
  { id: 283, difficulty: '3-4', category: 'hebrew', points: 1, question: 'מה שורש המילה "כתיבה"?',                   answers: ['כות', 'כתב', 'כתי', 'תכב'],                   correctIndex: 1 },
  { id: 284, difficulty: '3-4', category: 'hebrew', points: 1, question: 'איזו מילה בניין פיעל?',                     answers: ['כתב', 'כיתב', 'נכתב', 'הכתיב'],              correctIndex: 1 },
  { id: 285, difficulty: '3-4', category: 'hebrew', points: 1, question: 'מה מין המילה "שמש"?',                      answers: ['זכר', 'נקבה', 'שניהם', 'אין מין'],            correctIndex: 2 },
  { id: 286, difficulty: '3-4', category: 'hebrew', points: 1, question: 'מה שורש המילה "לימוד"?',                   answers: ['ליד', 'למד', 'לומ', 'מדל'],                   correctIndex: 1 },
  { id: 287, difficulty: '3-4', category: 'hebrew', points: 1, question: 'השלם: "הילד ___ את השיעור" (עבר)',         answers: ['למד', 'לומד', 'ילמד', 'ללמוד'],               correctIndex: 0 },
  { id: 288, difficulty: '3-4', category: 'hebrew', points: 1, question: 'מה הסמיכות של "בית + ספר"?',              answers: ['בית-ספר', 'ספר הבית', 'בית הספר', 'ספרבית'], correctIndex: 2 },
  { id: 289, difficulty: '3-4', category: 'hebrew', points: 1, question: 'מה בניין קל (פעל) בהווה לגוף שלישי זכר?', answers: ['כותב', 'מכתיב', 'נכתב', 'התכתב'],             correctIndex: 0 },
  { id: 290, difficulty: '3-4', category: 'hebrew', points: 1, question: 'מה שורש המילה "שמירה"?',                   answers: ['שמח', 'שמר', 'שים', 'מרש'],                   correctIndex: 1 },
  { id: 291, difficulty: '3-4', category: 'hebrew', points: 1, question: 'איזו מילה היא תואר הפועל?',                answers: ['מהר', 'מהיר', 'מהירות', 'להמהר'],             correctIndex: 0 },
  { id: 292, difficulty: '3-4', category: 'hebrew', points: 1, question: 'מה ריבוי של "גג"?',                        answers: ['גגים', 'גגות', 'גגן', 'גגות ←"גגות"'],        correctIndex: 0 },
  { id: 293, difficulty: '3-4', category: 'hebrew', points: 1, question: 'השלם: "היא תלמידה ___" (חכמה/חכם)',        answers: ['חכמה', 'חכם', 'חכמים', 'חכמות'],              correctIndex: 0 },
  { id: 294, difficulty: '3-4', category: 'hebrew', points: 1, question: 'מה שורש המילה "הכנה"?',                   answers: ['הכן', 'כנה', 'כון', 'הכנ'],                   correctIndex: 2 },
  { id: 295, difficulty: '3-4', category: 'hebrew', points: 1, question: 'איזו מילה בבניין נפעל?',                   answers: ['כתב', 'כיתב', 'נכתב', 'הכתיב'],              correctIndex: 2 },
  { id: 296, difficulty: '3-4', category: 'hebrew', points: 1, question: 'מה הנגזרת של "ספר" (פעולה)?',             answers: ['ספרות', 'ספרן', 'ספירה', 'ספרייה'],           correctIndex: 2 },
  { id: 297, difficulty: '3-4', category: 'hebrew', points: 1, question: 'מה צורת הציווי של "ללכת" (אתה)?',         answers: ['לך', 'הלך', 'ילך', 'לכת'],                    correctIndex: 0 },
  { id: 298, difficulty: '3-4', category: 'hebrew', points: 1, question: 'מה ההגדרה של "נרדף"?',                    answers: ['מילה שנרדפה', 'מילה בעלת משמעות דומה', 'מילה הפוכה', 'מילה ממקור זר'], correctIndex: 1 },
  { id: 299, difficulty: '3-4', category: 'hebrew', points: 1, question: 'מה שורש המילה "מגורים"?',                 answers: ['מגר', 'גור', 'גרם', 'מרג'],                   correctIndex: 1 },
  { id: 300, difficulty: '3-4', category: 'hebrew', points: 1, question: 'השלם: "הם ___ לבית הספר מחר" (עתיד)',     answers: ['הלכו', 'הולכים', 'ילכו', 'לכו'],              correctIndex: 2 },
  { id: 301, difficulty: '3-4', category: 'hebrew', points: 1, question: 'מה בניין הפעיל?',                          answers: ['כתב', 'כיתב', 'נכתב', 'הכתיב'],              correctIndex: 3 },
  { id: 302, difficulty: '3-4', category: 'hebrew', points: 1, question: 'מה סימן הרבים הנפוץ לנקבה?',              answers: ['ים-', 'ות-', 'ן-', 'ית-'],                    correctIndex: 1 },

  // ===== עברית – ה-ו (הבנת הנקרא) =====
  { id: 303, difficulty: '5-6', category: 'hebrew', points: 1, question: '"הנחש היה ערום מכל חית השדה." מה המילה "ערום" מסמלת כאן?', answers: ['עירום', 'חכם ומתוחכם', 'מהיר', 'יפה'],        correctIndex: 1 },
  { id: 304, difficulty: '5-6', category: 'hebrew', points: 1, question: 'מה הכלי הספרותי בביטוי "הלילה שחור כפחם"?', answers: ['אנפורה', 'השוואה (דמוי)', 'גוזמה', 'אירוניה'], correctIndex: 1 },
  { id: 305, difficulty: '5-6', category: 'hebrew', points: 1, question: 'מה הוא "מספר בכל יודע"?',                 answers: ['גיבור הסיפור', 'מספר שיודע הכל על הדמויות', 'קורא הסיפור', 'המחבר'], correctIndex: 1 },
  { id: 306, difficulty: '5-6', category: 'hebrew', points: 1, question: 'מה פירוש "פרסונה" בספרות?',               answers: ['גיבור שלילי', 'הדמות שמאחורי המחבר', 'מספר', 'סיפור מסגרת'], correctIndex: 1 },
  { id: 307, difficulty: '5-6', category: 'hebrew', points: 1, question: '"הים געה." מה הכלי הספרותי?',             answers: ['דמוי', 'גוזמה', 'אנימיזם', 'אנפורה'],         correctIndex: 2 },
  { id: 308, difficulty: '5-6', category: 'hebrew', points: 1, question: 'מה ההבדל בין עלילה לנושא?',               answers: ['עלילה=מה קורה, נושא=הרעיון המרכזי', 'נושא=מה קורה, עלילה=הרעיון', 'שניהם זהים', 'עלילה=הדמויות'], correctIndex: 0 },
  { id: 309, difficulty: '5-6', category: 'hebrew', points: 1, question: 'מה כינוי גוף "הם" בעברית?',               answers: ['גוף ראשון רבים', 'גוף שני רבים', 'גוף שלישי רבים זכר', 'גוף שלישי יחיד'], correctIndex: 2 },
  { id: 310, difficulty: '5-6', category: 'hebrew', points: 1, question: 'מה "אירוניה" בספרות?',                    answers: ['תיאור יפה', 'אמירה שמשמעה ההפך ממה שנאמר', 'חזרה על מילה', 'השוואה'], correctIndex: 1 },
  { id: 311, difficulty: '5-6', category: 'hebrew', points: 1, question: 'מה שורש המילה "הסתכלות"?',               answers: ['הסת', 'סכל', 'כלת', 'סכן'],                   correctIndex: 1 },
  { id: 312, difficulty: '5-6', category: 'hebrew', points: 1, question: 'מה בניין המילה "הסתכל"?',                 answers: ['פעל', 'פיעל', 'הפעיל', 'התפעל'],              correctIndex: 3 },
  { id: 313, difficulty: '5-6', category: 'hebrew', points: 1, question: '"חץ עבר בין עיניו." מה הכוונה?',           answers: ['חץ אמיתי עבר', 'מבט חד וקשה', 'הוא עיוור', 'הוא ירה'],  correctIndex: 1 },
  { id: 314, difficulty: '5-6', category: 'hebrew', points: 1, question: 'מה "פרולוג" בטקסט?',                      answers: ['פרק אחרון', 'הקדמה לסיפור', 'שיא העלילה', 'הסיום'],   correctIndex: 1 },
  { id: 315, difficulty: '5-6', category: 'hebrew', points: 1, question: 'מה ההבדל בין "קנאה" ל"קינאה"?',          answers: ['אין הבדל', 'קנאה=צמח, קינאה=רגש', 'קנאה=קנייה, קינאה=שירת אבל', 'שניהם שגויים'], correctIndex: 2 },
  { id: 316, difficulty: '5-6', category: 'hebrew', points: 1, question: 'מה "הדמות הראשית"?',                      answers: ['מספר', 'הגיבור המרכזי שסביבו הסיפור', 'הנבל', 'המחבר'], correctIndex: 1 },
  { id: 317, difficulty: '5-6', category: 'hebrew', points: 1, question: 'מה "גוזמה" (היפרבולה)?',                  answers: ['השוואה', 'הגזמה קיצונית לצרכי דגש', 'אנימיזם', 'חזרה'],  correctIndex: 1 },
  { id: 318, difficulty: '5-6', category: 'hebrew', points: 1, question: 'מה פירוש "דיאלוג"?',                      answers: ['תיאור סצנה', 'שיח בין דמויות', 'מונולוג פנימי', 'תיאור מקום'], correctIndex: 1 },
  { id: 319, difficulty: '5-6', category: 'hebrew', points: 1, question: 'מה "מבנה כיאסטי"?',                       answers: ['חזרה על מילים', 'A-B-B-A מבנה סימטרי הפוך', 'שורות שוות', 'חרוז'], correctIndex: 1 },
  { id: 320, difficulty: '5-6', category: 'hebrew', points: 1, question: 'מה "שיא העלילה" (קלימקס)?',               answers: ['תחילת הסיפור', 'נקודת המתח הגבוהה ביותר', 'הסיום', 'הרקע'],  correctIndex: 1 },
  { id: 321, difficulty: '5-6', category: 'hebrew', points: 1, question: 'מה ההבדל בין "שיר" ל"פרוזה"?',           answers: ['שיר=מחורז, פרוזה=לא', 'שיר מחולק לשורות ועשוי להיות מחורז, פרוזה=כתיבה רגילה', 'אין הבדל', 'שיר=קצר יותר'], correctIndex: 1 },
  { id: 322, difficulty: '5-6', category: 'hebrew', points: 1, question: 'מה "אלגוריה"?',                            answers: ['סיפור עם משמעות נסתרת', 'שיר אהבה', 'מחזה', 'סיפור ילדים'], correctIndex: 0 },

  // ===== עברית – ז-ח (הבנת הנקרא) =====
  { id: 323, difficulty: '7-8', category: 'hebrew', points: 1, question: 'מה "פסוק" בשירה?',                         answers: ['כל השיר', 'קבוצת שורות המהוות יחידה', 'שורה אחת', 'הכותרת'], correctIndex: 1 },
  { id: 324, difficulty: '7-8', category: 'hebrew', points: 1, question: 'מה ההבדל בין "סיפורת" ל"עובדה"?',         answers: ['סיפורת=קצרה, עובדה=ארוכה', 'סיפורת=בדיה, עובדה=מציאות', 'אין הבדל', 'סיפורת=שירה'], correctIndex: 1 },
  { id: 325, difficulty: '7-8', category: 'hebrew', points: 1, question: 'מה "מונולוג פנימי"?',                      answers: ['שיח בין דמויות', 'מחשבות הדמות שנחשפות לקורא', 'תיאור נוף', 'מספר חיצוני'], correctIndex: 1 },
  { id: 326, difficulty: '7-8', category: 'hebrew', points: 1, question: 'מה "אנאפורה"?',                            answers: ['השוואה', 'חזרה על מילה/ביטוי בתחילת שורות', 'גוזמה', 'דמוי'], correctIndex: 1 },
  { id: 327, difficulty: '7-8', category: 'hebrew', points: 1, question: '"לא שמע ולא ראה." מה הכלי הספרותי?',      answers: ['ניגוד', 'מבנה מקבילי', 'גוזמה', 'אנפורה'],    correctIndex: 1 },
  { id: 328, difficulty: '7-8', category: 'hebrew', points: 1, question: 'מה "נקודת מבט גוף ראשון"?',               answers: ['המספר מחוץ לסיפור', 'הגיבור עצמו מספר', 'כל יודע', 'מספר אנונימי'], correctIndex: 1 },
  { id: 329, difficulty: '7-8', category: 'hebrew', points: 1, question: 'מה "אוקסימורון"?',                         answers: ['מילה בכמה משמעויות', 'שיתוף שני מושגים סותרים', 'חרוז', 'המחשה'], correctIndex: 1 },
  { id: 330, difficulty: '7-8', category: 'hebrew', points: 1, question: 'מה "קונפליקט" בסיפורת?',                  answers: ['הסיום', 'המתח/סכסוך שמניע את הסיפור', 'הגיבור', 'הרקע'],  correctIndex: 1 },
  { id: 331, difficulty: '7-8', category: 'hebrew', points: 1, question: 'מה ההבדל בין "גלוי" ל"סמוי"?',           answers: ['גלוי=נאמר ישירות, סמוי=רמוז', 'גלוי=חזק, סמוי=חלש', 'אין הבדל', 'גלוי=ישן, סמוי=חדש'], correctIndex: 0 },
  { id: 332, difficulty: '7-8', category: 'hebrew', points: 1, question: 'מה "אינטרטקסטואליות"?',                   answers: ['השוואת טקסטים', 'הפניה לטקסט אחר בתוך הטקסט', 'תרגום', 'ציטוט'],  correctIndex: 1 },
  { id: 333, difficulty: '7-8', category: 'hebrew', points: 1, question: 'מה "אנטיגיבור"?',                          answers: ['הנבל', 'גיבור שאינו מצטיין בסגולות קלאסיות', 'הגיבור הראשי', 'דמות משנית'], correctIndex: 1 },
  { id: 334, difficulty: '7-8', category: 'hebrew', points: 1, question: 'מה "עקידת יצחק" כסמל בספרות ישראלית?',   answers: ['סמל לגבורה', 'סמל לקורבן ואמונה', 'סמל לאהבת אב', 'סמל למדבר'],  correctIndex: 1 },
  { id: 335, difficulty: '7-8', category: 'hebrew', points: 1, question: 'מה "חרוז" בשירה?',                         answers: ['קצב', 'הקבלת צלילים בסוף שורות', 'חזרה על מילה', 'מבנה A-B'],  correctIndex: 1 },
  { id: 336, difficulty: '7-8', category: 'hebrew', points: 1, question: 'מה "פלאשבק"?',                             answers: ['קפיצה קדימה בזמן', 'חזרה לאחור בזמן', 'עצירת הזמן', 'זמן הווה'],  correctIndex: 1 },
  { id: 337, difficulty: '7-8', category: 'hebrew', points: 1, question: 'מה "טון" בטקסט?',                          answers: ['הנושא', 'הגישה הרגשית שהכותב מביע', 'הסגנון הלשוני', 'הסיום'],   correctIndex: 1 },
  { id: 338, difficulty: '7-8', category: 'hebrew', points: 1, question: 'מה "פרדוקס"?',                             answers: ['משפט שנראה סתרנותי אך מכיל אמת', 'גוזמה', 'שאלה רטורית', 'חרוז'],  correctIndex: 0 },
  { id: 339, difficulty: '7-8', category: 'hebrew', points: 1, question: 'מה ההבדל בין "יצירה אפית" ל"לירית"?',    answers: ['אפית=ארוכה, לירית=קצרה', 'אפית=מספרת עלילה, לירית=מבטאת רגשות', 'אין הבדל', 'אפית=שירה, לירית=פרוזה'], correctIndex: 1 },
  { id: 340, difficulty: '7-8', category: 'hebrew', points: 1, question: 'מה "מסגרת נרטיבית"?',                     answers: ['כותרת הסיפור', 'סיפור שבתוכו מוטמעים סיפורים אחרים', 'הפרק האחרון', 'ההקדמה'], correctIndex: 1 },
  { id: 341, difficulty: '7-8', category: 'hebrew', points: 1, question: 'מה "רמז מקראי" בספרות?',                  answers: ['ציטוט ישיר', 'הפניה לטקסט מקראי להוסיף עומק', 'תרגום ממקרא', 'ביקורת'],  correctIndex: 1 },
  { id: 342, difficulty: '7-8', category: 'hebrew', points: 1, question: 'מה "קתרזיס" לפי אריסטו?',                answers: ['הזדהות עם הגיבור', 'טיהור רגשי שחש הקורא/צופה', 'שיא העלילה', 'הסיום'],  correctIndex: 1 },

  // ===== עברית – ט-י (הבנת הנקרא) =====
  { id: 343, difficulty: '9-10', category: 'hebrew', points: 1, question: 'מה "זרם התודעה" (stream of consciousness)?', answers: ['תיאור מקום', 'טכניקת כתיבה המשקפת מחשבות ורגשות ספונטניים', 'מספר חיצוני', 'שיח ישיר'], correctIndex: 1 },
  { id: 344, difficulty: '9-10', category: 'hebrew', points: 1, question: 'מה ההבדל בין "סמל" ל"סימן"?',            answers: ['אין הבדל', 'סמל=ייצוג עמוק ותרבותי, סימן=הפניה מוסכמת פשוטה', 'סמל=חזותי, סימן=כתוב', 'סמל=ישן, סימן=מודרני'], correctIndex: 1 },
  { id: 345, difficulty: '9-10', category: 'hebrew', points: 1, question: 'מה "נרטיב לא אמין"?',                    answers: ['סיפור מוגזם', 'מספר שאינו מהימן לחלוטין', 'סיפור בדיוני', 'מספר אנונימי'],  correctIndex: 1 },
  { id: 346, difficulty: '9-10', category: 'hebrew', points: 1, question: 'מה "אקספוזיציה" בסיפור?',                answers: ['שיא העלילה', 'הצגת הרקע, הדמויות והמצב ההתחלתי', 'הסיום', 'הקונפליקט'],  correctIndex: 1 },
  { id: 347, difficulty: '9-10', category: 'hebrew', points: 1, question: 'מה "לייטמוטיב"?',                        answers: ['כלי מוזיקלי', 'מניע/נושא החוזר ביצירה כחוט מקשר', 'אנפורה', 'חרוז'],  correctIndex: 1 },
  { id: 348, difficulty: '9-10', category: 'hebrew', points: 1, question: 'מה "ז\'אנר"?',                           answers: ['כותב', 'סוג/קטגוריה ספרותית', 'תקופה', 'מגמה'],           correctIndex: 1 },
  { id: 349, difficulty: '9-10', category: 'hebrew', points: 1, question: 'מה מאפיין ספרות "מודרניסטית"?',          answers: ['עלילה ליניארית ברורה', 'שבירת מוסכמות, נרטיב מורכב, חקר תודעה', 'גיבורים קלאסיים', 'סיום מאושר'],  correctIndex: 1 },
  { id: 350, difficulty: '9-10', category: 'hebrew', points: 1, question: 'מה "עמדת הסופר"?',                       answers: ['מקום הכתיבה', 'השקפת עולמו שמשתקפת ביצירה', 'הז\'אנר', 'הסגנון'],  correctIndex: 1 },
  { id: 351, difficulty: '9-10', category: 'hebrew', points: 1, question: 'מה "הפואטיקה של אריסטו" עוסקת בה?',      answers: ['מוזיקה', 'עקרונות השירה והסיפורת', 'פילוסופיה', 'פוליטיקה'],  correctIndex: 1 },
  { id: 352, difficulty: '9-10', category: 'hebrew', points: 1, question: 'מה "בלדה"?',                             answers: ['שיר לירי אישי', 'שיר עלילתי עממי לרוב מחורז', 'פרוזה קצרה', 'מחזה'],  correctIndex: 1 },
  { id: 353, difficulty: '9-10', category: 'hebrew', points: 1, question: 'מה "מבנה טלסקופי"?',                    answers: ['סיפור ישיר קדימה', 'סיפורים המוטמעים זה בתוך זה', 'חזרה לאחור', 'עלילה מקבילה'],  correctIndex: 1 },
  { id: 354, difficulty: '9-10', category: 'hebrew', points: 1, question: 'מה "ספרות זרם התודעה" הושפעה מ?',        answers: ['מרקסיזם', 'פסיכואנליזה פרוידיאנית', 'רומנטיקה', 'ריאליזם'],  correctIndex: 1 },
  { id: 355, difficulty: '9-10', category: 'hebrew', points: 1, question: 'מה "כינוי"?',                            answers: ['תואר', 'מילה המחליפה שם עצם', 'פועל עזר', 'מילת יחס'],  correctIndex: 1 },
  { id: 356, difficulty: '9-10', category: 'hebrew', points: 1, question: 'מה ייחודי ל"שיר לא מחורז" (חופשי)?',    answers: ['אין משמעות', 'אין קצב וחרוז קבועים, חופש ביטוי מלא', 'קצר מאוד', 'תמיד עצוב'],  correctIndex: 1 },
  { id: 357, difficulty: '9-10', category: 'hebrew', points: 1, question: 'מה "אובייקטיביזציה" בספרות?',           answers: ['תיאור רגשי', 'ייצוג רגשות דרך אובייקטים חיצוניים', 'גוזמה', 'אירוניה'],  correctIndex: 1 },
  { id: 358, difficulty: '9-10', category: 'hebrew', points: 1, question: 'מה "פיגורה" (figure of speech)?',        answers: ['דמות בסיפור', 'שימוש לא מילולי בשפה לצרכי אפקט', 'קצב', 'נרטיב'],  correctIndex: 1 },
  { id: 359, difficulty: '9-10', category: 'hebrew', points: 1, question: 'מה "הנחת יסוד" בטיעון?',                answers: ['מסקנה', 'הנחה שמוצגת כאמת בלי הוכחה', 'דוגמה', 'ראיה'],  correctIndex: 1 },
  { id: 360, difficulty: '9-10', category: 'hebrew', points: 1, question: 'מה "מחזה אבסורד"?',                     answers: ['מחזה מצחיק', 'מחזה המדגיש חוסר משמעות הקיום', 'מחזה היסטורי', 'טרגדיה'],  correctIndex: 1 },
  { id: 361, difficulty: '9-10', category: 'hebrew', points: 1, question: 'מה "אמפתיה" ב"הבנת הנקרא"?',            answers: ['הסכמה עם הכותב', 'הזדהות עם רגשות הדמות', 'ביקורת', 'ניתוח'],  correctIndex: 1 },
  { id: 362, difficulty: '9-10', category: 'hebrew', points: 1, question: 'מה "אפיגרף"?',                           answers: ['הפרק האחרון', 'ציטוט בפתח היצירה המרמז על נושאה', 'כותרת', 'הקדשה'],  correctIndex: 1 },

  // ===== עברית – י"א-י"ב (הבנת הנקרא) =====
  { id: 363, difficulty: '11-12', category: 'hebrew', points: 1, question: 'מה "דקונסטרוקציה" כגישה ביקורתית?',    answers: ['בנייה מחדש', 'פירוק הטקסט לחשוף סתירות פנימיות', 'ניתוח דמויות', 'השוואת טקסטים'],  correctIndex: 1 },
  { id: 364, difficulty: '11-12', category: 'hebrew', points: 1, question: 'מה "ביקורת פמיניסטית" בספרות?',        answers: ['ניתוח שפה', 'קריאת טקסטים מנקודת מבט מגדרית', 'ביקורת מרקסיסטית', 'ניתוח היסטורי'],  correctIndex: 1 },
  { id: 365, difficulty: '11-12', category: 'hebrew', points: 1, question: 'מה "אינטנציית המחבר" בביקורת ספרותית?', answers: ['מה הקורא מבין', 'הכוונה המקורית של הכותב', 'מה הטקסט אומר כשלעצמו', 'השפעת הטקסט'],  correctIndex: 1 },
  { id: 366, difficulty: '11-12', category: 'hebrew', points: 1, question: 'מה "ביקורת חדשה" (New Criticism)?',    answers: ['ביקורת עכשווית', 'גישה המתמקדת בטקסט בלבד ללא הקשר', 'ביקורת פמיניסטית', 'ביקורת מרקסיסטית'],  correctIndex: 1 },
  { id: 367, difficulty: '11-12', category: 'hebrew', points: 1, question: 'מה מאפיין ספרות "פוסטמודרנית"?',      answers: ['נרטיב ליניארי', 'רב-קוליות, מטאפיקציה, ערעור על אמת', 'גיבורים אידיאליים', 'סיום חד-משמעי'],  correctIndex: 1 },
  { id: 368, difficulty: '11-12', category: 'hebrew', points: 1, question: 'מה "מטאפיקציה"?',                      answers: ['פיקציה מדעית', 'יצירה המדברת על עצמה כיצירה', 'ביוגרפיה', 'מסה'],  correctIndex: 1 },
  { id: 369, difficulty: '11-12', category: 'hebrew', points: 1, question: 'מה "הגמוניה תרבותית" לפי גרמשי?',      answers: ['שלטון צבאי', 'שליטה חברתית דרך ערכים ותרבות', 'שפה דומיננטית', 'כלכלה'],  correctIndex: 1 },
  { id: 370, difficulty: '11-12', category: 'hebrew', points: 1, question: 'מה "גוף בטקסט" בתיאוריה פמיניסטית?',  answers: ['תיאור פיזי', 'הגוף כמקום של זהות, כוח ופוליטיקה', 'ביולוגיה', 'רפואה'],  correctIndex: 1 },
  { id: 371, difficulty: '11-12', category: 'hebrew', points: 1, question: 'מה "דיאלקטיקה" ב"הבנת הנקרא"?',       answers: ['שיטת שאלות ותשובות להגיע לאמת', 'ניגוד בין דמויות', 'מבנה השיר', 'קונפליקט'],  correctIndex: 0 },
  { id: 372, difficulty: '11-12', category: 'hebrew', points: 1, question: 'מה "ספרות קנון"?',                     answers: ['ספרות דתית', 'יצירות שנחשבות חיוניות בתרבות', 'ספרות לילדים', 'ספרות עממית'],  correctIndex: 1 },
  { id: 373, difficulty: '11-12', category: 'hebrew', points: 1, question: 'מה "ייצוג ה-אחר" בספרות פוסטקולוניאלית?', answers: ['גיבור שלילי', 'כיצד התרבות הדומיננטית מתארת קבוצות שוליות', 'דמות משנית', 'מספר'],  correctIndex: 1 },
  { id: 374, difficulty: '11-12', category: 'hebrew', points: 1, question: 'מה "קריאה סימפטומטית"?',               answers: ['קריאה מהירה', 'קריאה שמחפשת את מה שהטקסט מסתיר', 'קריאה ליניארית', 'קריאה פשוטה'],  correctIndex: 1 },
  { id: 375, difficulty: '11-12', category: 'hebrew', points: 1, question: 'מה "ביוגרפי-ביקורתי" כגישה?',         answers: ['ניתוח פנימי של הטקסט', 'קשר בין חיי הסופר ליצירתו', 'ביקורת תרבותית', 'ניתוח שפה'],  correctIndex: 1 },
  { id: 376, difficulty: '11-12', category: 'hebrew', points: 1, question: 'מה "מרחב" ב"ביקורת הנקרא"?',           answers: ['תיאור הנוף', 'המרחב כסמל לזהות, כוח ומגדר', 'הגדרה פיזית', 'רקע'],  correctIndex: 1 },
  { id: 377, difficulty: '11-12', category: 'hebrew', points: 1, question: 'מה "אינטרסוביקטיביות"?',               answers: ['שיח בין שניים', 'משמעות הנוצרת בין סובייקטים שונים', 'ביקורת', 'ניתוח'],  correctIndex: 1 },
  { id: 378, difficulty: '11-12', category: 'hebrew', points: 1, question: 'מה "שיח" (discourse) לפי פוקו?',       answers: ['שיחה', 'מערכת של ידע וכוח המעצבת את המציאות', 'טקסט', 'נרטיב'],  correctIndex: 1 },
  { id: 379, difficulty: '11-12', category: 'hebrew', points: 1, question: 'מה "ריבוי קולות" (polyphony) לפי בחטין?', answers: ['שירת מקהלה', 'מספר קולות/נקודות מבט שווי ערך ביצירה', 'מספר בגוף שלישי', 'אנפורה'],  correctIndex: 1 },
  { id: 380, difficulty: '11-12', category: 'hebrew', points: 1, question: 'מה "ספרות מגמה"?',                     answers: ['ספרות ז\'אנר', 'ספרות המשרתת מטרה אידיאולוגית/חברתית', 'ספרות קלאסית', 'ספרות ילדים'],  correctIndex: 1 },
  { id: 381, difficulty: '11-12', category: 'hebrew', points: 1, question: 'מה "הסובייקט הלירי"?',                 answers: ['הכותב עצמו', 'קול הדובר בשיר, לאו דווקא הסופר', 'הקורא', 'הנושא'],  correctIndex: 1 },
  { id: 382, difficulty: '11-12', category: 'hebrew', points: 1, question: 'מה "קריאת אבל" (mourning reading)?',   answers: ['קריאה עצובה', 'קריאה המכירה בחוסר האפשרות לשחזר את כוונת המחבר', 'ביקורת', 'פרשנות'],  correctIndex: 1 },

  // ===== עברית – אוניברסיטה (הבנת הנקרא) =====
  { id: 383, difficulty: 'university', category: 'hebrew', points: 1, question: 'מה "התפנות מהמחבר" (death of the author) לפי רולאן בארת?', answers: ['המחבר מת', 'הטקסט עצמאי ממחברו, הקורא יוצר את המשמעות', 'הטקסט אינו חשוב', 'הביוגרפיה חשובה'],  correctIndex: 1 },
  { id: 384, difficulty: 'university', category: 'hebrew', points: 1, question: 'מה "ביקורת פוסטקולוניאלית"?',      answers: ['ביקורת של ספרות מאוחרת', 'ניתוח השפעת הקולוניאליזם על ספרות ותרבות', 'ביקורת מרקסיסטית', 'גישה פמיניסטית'],  correctIndex: 1 },
  { id: 385, difficulty: 'university', category: 'hebrew', points: 1, question: 'מה "מיתוס" לפי רולאן בארת ב"מיתולוגיות"?', answers: ['סיפור עתיק', 'מערכת של משמעויות המחביאה אידיאולוגיה בורגנית', 'אגדת עם', 'דת'],  correctIndex: 1 },
  { id: 386, difficulty: 'university', category: 'hebrew', points: 1, question: 'מה "הפרדיגמה" לפי תומאס קון?',     answers: ['מסגרת מחשבתית שמנחה מחקר מדעי', 'תיאוריה ספרותית', 'שיטת כתיבה', 'ניתוח נרטיב'],  correctIndex: 0 },
  { id: 387, difficulty: 'university', category: 'hebrew', points: 1, question: 'מה "הטרוגלוסיה" לפי בחטין?',       answers: ['שפה אחידה', 'ריבוי שפות וסגנונות בתוך טקסט', 'שפה זרה', 'שיח'],  correctIndex: 1 },
  { id: 388, difficulty: 'university', category: 'hebrew', points: 1, question: 'מה "ביקורת לאקאניאנית"?',          answers: ['ביקורת שפה', 'קריאה דרך תיאוריית הפסיכואנליזה של לאקאן', 'ביקורת מרקסיסטית', 'ביקורת פמיניסטית'],  correctIndex: 1 },
  { id: 389, difficulty: 'university', category: 'hebrew', points: 1, question: 'מה "הבדל" (differance) לפי דרידה?', answers: ['הבדל משמעות', 'הדחיה הנצחית של משמעות, שפה כמערכת הבדלים', 'ניגוד', 'אנטיתזה'],  correctIndex: 1 },
  { id: 390, difficulty: 'university', category: 'hebrew', points: 1, question: 'מה "ביקורת ניו היסטוריסיזם"?',    answers: ['ניתוח עצמאי של הטקסט', 'הטמעת הטקסט בהקשר ההיסטורי והתרבותי', 'ביקורת שפה', 'ביקורת פסיכולוגית'],  correctIndex: 1 },
  { id: 391, difficulty: 'university', category: 'hebrew', points: 1, question: 'מה "כיוון מחקר קוויר" בספרות?',   answers: ['ספרות רומנטית', 'ניתוח זהות מינית ומגדרית בטקסטים', 'ביקורת פמיניסטית בלבד', 'ניתוח דמויות'],  correctIndex: 1 },
  { id: 392, difficulty: 'university', category: 'hebrew', points: 1, question: 'מה "אקוקריטיקה" (ecocriticism)?', answers: ['ביקורת כלכלית', 'מחקר יחסי ספרות וסביבה/טבע', 'ביקורת אקולוגית של שפה', 'ניתוח מרחב'],  correctIndex: 1 },
];
